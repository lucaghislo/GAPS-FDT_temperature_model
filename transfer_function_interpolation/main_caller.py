...
# Config
tau = 6  # Peaking time
fdt = t8.gaps_fdt_tanh_8_params  # Transfer function
guess = t8.weights_fdt_tanh_8_params  # Initial values for parameter estimation
n_params = 8  # Number of parameters for transfer function model
min_ch = 0  # Starting channel for evaluation
max_ch = 0  # Finishing channel for evaluation
